...
@interface LQ_CBCZ_Detail_ChuLi_Controller ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@implementation LQ_CBCZ_Detail_ChuLi_Controller
...
- (IBAction)commitClick:(UIButton *)sender {
    ...
    NSDictionary * dic = @{@"xxid":self.bianhao,
